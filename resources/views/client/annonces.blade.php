    ...
    <div class="flex flex-col md:flex-row">
        ...
        <form method="GET" action="{{ route('annonces') }}" id="mainFilterForm" class="w-full md:w-64 bg-white p-5 shadow-md sticky-sidebar md:mt-4 md:ml-4">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('annonces') }}" class="flex-1 bg-gray-200 text-gray-700 py-2 rounded hover:bg-gray-300 transition text-center">
                    Réinitialiser
                </a>
            </div>
        </form>
            ...
            <a href="#">
                ...
                <div class="px-4 py-3 w-72">
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <p class="text-lg font-semibold text-black">{{ $annonce->prix }} Dhs</p>
