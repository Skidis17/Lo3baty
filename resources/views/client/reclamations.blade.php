              ...
              <tr class="table-row">
                ...
                <td class="px-8 py-5 whitespace-nowrap">
                  <div class="flex flex-col">
                    <span class="font-medium">{{ $reclamation->created_at->format('d/m/Y') }}</span>
                    <span class="text-slate-400 text-sm">{{ $reclamation->created_at->format('H:i') }}</span>
                  </div>
                </td>
                <td class="px-8 py-5 whitespace-nowrap">
                ...
                <td class="px-8 py-5 whitespace-nowrap">
                  <button onclick="viewComplaint(this)" 
                          ...
                          data-date="{{ $reclamation->created_at->format('d/m/Y à H:i') }}"
      ...
      <div class="bg-slate-50 p-6 rounded-lg mb-6">
        ...
        <div id="responseContainer" class="mt-6">
          ...
          <div class="response-bubble p-4">
            <p id="complaintResponse" class="text-slate-600 whitespace-pre-line"></p>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  // Appeler cette fonction à chaque ouverture de modal et lors du redimensionnement
  window.addEventListener('resize', adjustModalHeight);
    ...
    function viewComplaint(button) {
      ...
      document.getElementById('complaintDate').innerText = date;
      document.getElementById('complaintSubject').innerText = sujet;
      document.getElementById('complaintMessage').innerText = contenu;
      ...
      if (reponse && reponse.trim() !== '') {
        responseElement.innerText = reponse;
