...
<div class="p-6 max-w-xl mx-auto">
    ...
    <form action="<?php echo e(route('partner.products.store')); ?>" method="POST" class="space-y-4">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.partner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\laravelWeb\resources\views/partner/products/create.blade.php ENDPATH**/ ?>